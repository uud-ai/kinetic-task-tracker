    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mx-auto space-y-12">
      <header>
        <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-primary mb-3 block">
          Архитектурный куратор
        </span>
        <h2 className="font-headline font-extrabold text-4xl lg:text-5xl text-on-surface tracking-tight leading-none mb-6">
          Новая задача
        </h2>
        <p className="text-on-surface-variant text-lg max-w-md">
          Превратите свои идеи в структурированное действие в вашей цифровой студии.
        </p>
      </header>
